...
/**
 * @summary Sign in or sign up with phone only (no OTP)
 */
...
export type LoginPhoneMutationResult = NonNullable<
  Awaited<ReturnType<typeof loginPhone>>
>;
export type LoginPhoneMutationBody = BodyType<SendOtpRequest>;
export type LoginPhoneMutationError = ErrorType<ErrorResponse>;
